...
namespace MyClothes.Migrations
{
    ...
    [Migration("20220907211159_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyClothes.Data.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MyClothes.Data.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("MyClothes.Data.Models.Colour", b =>
                {
            ...
            modelBuilder.Entity("MyClothes.Data.Models.Garment", b =>
                {
            ...
            modelBuilder.Entity("MyClothes.Data.Models.Image", b =>
                {
                    b.Property<string>("ImageId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("AddedByAppUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MyClothes.Data.Models.Season", b =>
                {
                    b.Property<string>("SeasonId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            SeasonId = "4abb8f47-ddac-411d-996c-419c65eb850f",
                            Name = "Autumn "
                        },
                        new
                        {
                            SeasonId = "2292e74a-83d7-4bfe-9518-ec0dbdf16b39",
                            Name = "Winter"
                        },
                        new
                        {
                            SeasonId = "b9ab67eb-a8b5-4d2a-a6cd-f59c363c0eca",
                            Name = "Spring"
                        },
                        new
                        {
                            SeasonId = "a6cdf417-f255-4b9a-8395-0f46159df25b",
                            Name = "Summer"
                        });
                });

            modelBuilder.Entity("MyClothes.Data.Models.UserCategory", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MyClothes.Data.Models.UserGarment", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("AppUserId", "GarmentId");

                    b.HasIndex("AppUserId1");

                    b.HasIndex("GarmentId");

                    b.ToTable("UserGarments");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyClothes.Data.Models.AppUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyClothes.Data.Models.Garment", b =>
                {
                    b.HasOne("MyClothes.Data.Models.AppUser", "AppUser")
                        .WithMany("UserClothesCollection")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MyClothes.Data.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId");

                    b.HasOne("MyClothes.Data.Models.Colour", "Colour")
                        .WithMany()
                        .HasForeignKey("ColourId");

                    b.HasOne("MyClothes.Data.Models.Season", "Season")
                        .WithMany()
            ...
            modelBuilder.Entity("MyClothes.Data.Models.Image", b =>
                {
                    b.HasOne("MyClothes.Data.Models.AppUser", "AddedByAppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyClothes.Data.Models.UserGarment", b =>
                {
                    ...
                    b.HasOne("MyClothes.Data.Models.Garment", "Garment")
                        .WithMany()
